...
import { youtubeOptimizerWorkflow } from "./workflows/youtubeOptimizerWorkflow";
import { registerCronTrigger } from "../triggers/cronTriggers";
import { createDashboardRoutes } from "./api/dashboardRoutes";

// Register cron trigger for YouTube optimizer workflow
// Runs daily at 9 AM UTC by default (can be overridden via environment variable)
registerCronTrigger({
  cronExpression: process.env.SCHEDULE_CRON_EXPRESSION || "0 9 * * *",
  workflow: youtubeOptimizerWorkflow,
});
// ======================================================================
...
export const mastra = new Mastra({
  ...
  workflows: { youtubeOptimizerWorkflow },
  // Register your agents here
  agents: { youtubeOptimizerAgent },
  bundler: {
