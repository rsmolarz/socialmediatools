...
Return JSON:
{
  ...
  "tips": ["5 email sequence optimization tips"]
    ...
    const BOT_PROMPTS: Record<string, string> = {
          ...
          "tone-of-voice": `You are the Tone of Voice Bot. Help the user define and refine their unique brand voice and communication style. Ask about their personality, values, audience, and goals — then generate tone guidelines and example content in their voice.`,
          "captivating-content": `You are the Captivating Content Bot. Help the user create compelling, engaging content that captures and holds attention. Guide them through hooks, storytelling, and value delivery.`,
          "pillar-point": `You are the Pillar Point Bot. Help the user identify and develop their core content pillars and key talking points that support their brand message and expertise.`,
          "story": `You are the Story Bot. Help the user mine, structure, and tell their most powerful personal and professional stories for content, presentations, and marketing.`,
